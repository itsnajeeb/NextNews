        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <table class="content-table">
                    ...
                    <tbody>
                        ...
                        elseif($_SESSION['role']==0){
                            $sql = "SELECT * FROM post INNER JOIN category ON post.category=category.category_id INNER JOIN user ON post.author=user.user_id  WHERE post.author='$userId' LIMIT $offset,$limit";
                        }
                        $result = mysqli_query($conn, $sql) or die("Query Failed ");
                        $cnt = 1;
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                //    echo  $row['post']; echo "<br>";
                ...
                $query = mysqli_query($conn, $sql1);
                 $totalPage = ceil(mysqli_num_rows($query) / $limit);
